...
public class CodeMsg {
	...
	//后台物品分类管理类错误码
	public static CodeMsg ADMIN_GOODSCATEGORY_ADD_ERROR = new CodeMsg(-9000, "分类添加失败，请联系管理员韩！");
	public static CodeMsg ADMIN_GOODSCATEGORY_EDIT_ERROR = new CodeMsg(-9001, "分类编辑失败，请联系管理员韩！");
	public static CodeMsg ADMIN_GOODSCATEGORY_DELETE_ERROR = new CodeMsg(-9002, "分类删除失败，因为存在子分类，请联系管理员韩！");
	
	
	//前端用户注册类错误码
	public static CodeMsg HOME_STU_REGISTER_ERROR_SN_EXIST = new CodeMsg(-10000, "好巧哦，该账号已存在，请更换or联系管理员韩");
	public static CodeMsg HOME_STU_REGISTER_ERROR = new CodeMsg(-10001, "注册失败，请联系管理员韩");
