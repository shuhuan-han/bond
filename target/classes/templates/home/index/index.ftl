    ...
    <div class="container">
   		<div class="main center">
            ...
            <ul class="recom-list group">
                <li><a href="http://www.2shoujie.com/publishRule" target="_top">今日新闻</a></li>
                                <li><a href="http://www.2shoujie.com/article/4.html" target="_top">购买债券注意事项</a></li>
            </ul>
        </div>
        ...
        <div class="item-list">
            <ul class="items clearfix">
            	<li class="item">
                    <a href="http://hust.2shoujie.com/goods/169685.html" class="img" target="_top"><img src="/home/imgs/index_logo.png" alt="MacbookPro 13寸 12年版"></a>
                    <div class="info">
                        ...
                        <div class="place"><span>韩书焕</span></div>
