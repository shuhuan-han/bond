  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.html"><img src="/admin/images/index_logo.png" title="不是数组" alt="不是数组" /></a>
      </div>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>修改债券分类</h4></div>
              <div class="card-body">
                <form action="add" id="category-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" readonly="readonly" class="form-control required" id="icon" name="icon" value="${goodsCategory.icon}" placeholder="请上传分类icon" tips="请选择分类icon" />
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${goodsCategory.name}" placeholder="请输入分类名称" tips="请填写分类名称" />
                  </div>
                  <div class="input-group m-b-10">
